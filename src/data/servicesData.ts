    ...
    subcategories: [
      ...
      },
      {
        ...
        services: [
          ...
          { id: "laser-balicek-pera-brada", name: "Horná pera + brada", description: "Kompletné ošetrenie dolnej časti tváre.", duration: "45min", price: "39 € (pôvodne 49 €)", benefits: ["20% zľava", "Kompletné ošetrenie", "Dve zóny"], targetGroup: "Pre ženy aj mužov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-balicek-predkolenie-bikiny", name: "Predkolenie + bikiny", description: "Výhodná kombinácia pre dolnú časť tela.", duration: "1h 10min", price: "158 € (pôvodne 198 €)", benefits: ["20% zľava", "Výhodná kombinácia", "Dve zóny"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-balicek-stehna-bikiny", name: "Stehná + bikiny", description: "Ošetrenie stehien s bikínovou líniou.", duration: "1h", price: "135 € (pôvodne 169 €)", benefits: ["20% zľava", "Výhodná kombinácia", "Dve zóny"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-balicek-nohy-fullintim", name: "Celé nohy + full intim", description: "Kompletné ošetrenie nôh s intímnou oblasťou.", duration: "1h 45min", price: "191 € (pôvodne 239 €)", benefits: ["20% zľava", "Kompletné ošetrenie", "Dve zóny"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-balicek-brucho-bikiny", name: "Celé brucho + bikiny", description: "Ošetrenie brucha s bikínovou líniou.", duration: "1h", price: "111 € (pôvodne 139 €)", benefits: ["20% zľava", "Výhodná kombinácia", "Dve zóny"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-balicek-chrbat-ramena", name: "Celý chrbát + ramená", description: "Kompletné ošetrenie chrbta a ramien.", duration: "1h 30min", price: "188 € (pôvodne 235 €)", benefits: ["20% zľava", "Kompletné ošetrenie", "Dve zóny"], targetGroup: "Pre mužov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-balicek-cele-telo-zena", name: "Celé telo – žena (nohy + bikiny + podpazušie + ruky)", description: "Najkompletnejší balíček pre ženy so všetkými hlavnými zónami.", duration: "3h", price: "309 € (pôvodne 386 €)", benefits: ["20% zľava", "Kompletná starostlivosť", "Štyri zóny", "Najväčšia úspora"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk", isPopular: true },
          { id: "laser-balicek-cele-telo-muz", name: "Celé telo – muž (hruď + chrbát + ramená)", description: "Kompletný balíček pre mužov na hornú časť tela.", duration: "2h", price: "268 € (pôvodne 335 €)", benefits: ["20% zľava", "Kompletná starostlivosť", "Tri zóny", "Veľká úspora"], targetGroup: "Pre mužov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk", isPopular: true }
        ]
      },
      {
        id: "laser-sezonne-akcie",
        name: "🔥 Sezónne akcie a špeciálne ponuky",
        description: "Limitované sezónne akcie a exkluzívne ponuky pre nových aj stálych klientov.",
        services: [
          { id: "laser-akcia-bikini-ready", name: "BIKINI READY – letná akcia", description: "Pripravte sa na leto! Bikiny + podpazušie + predkolenie za zvýhodnenú cenu. Platí do konca júna.", duration: "1h 30min", price: "179 € (úspora 68 €)", benefits: ["30% zľava", "Tri zóny", "Letná príprava", "Limitovaná ponuka"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk", isPopular: true },
          { id: "laser-akcia-zimny-reset", name: "ZIMNÝ RESET – zimná akcia", description: "Ideálny čas na začatie epilácie! Celé nohy + bikiny za špeciálnu zimnú cenu.", duration: "1h 30min", price: "169 € (úspora 79 €)", benefits: ["32% zľava", "Dve zóny", "Ideálny štart v zime", "Limitovaná ponuka"], targetGroup: "Pre ženy", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk", isPopular: true },
          { id: "laser-akcia-prvy-krat", name: "FIRST VISIT – bonus pre nových klientov", description: "Prvá návšteva? Získajte 25% zľavu na akúkoľvek zónu laserovej epilácie.", duration: "individuálna", price: "25% zľava na prvú návštevu", benefits: ["25% zľava", "Platí na všetky zóny", "Iba pre nových klientov"], targetGroup: "Pre nových klientov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-akcia-priatelka", name: "BRING A FRIEND – akcia s priateľkou", description: "Príďte s priateľkou a obe získate 20% zľavu na celú objednávku.", duration: "individuálna", price: "20% zľava pre obe", benefits: ["20% zľava", "Platí pre obe klientky", "Kombinovateľné so službami"], targetGroup: "Pre kamarátky", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-akcia-kura-6", name: "KÚRA 6 – vernostná akcia", description: "Pri zakúpení kúry 6 ošetrení získate 6. ošetrenie ZDARMA.", duration: "individuálna", price: "5+1 ZDARMA", benefits: ["6. ošetrenie zdarma", "Platí na všetky zóny", "Ideálne pre kompletný cyklus"], targetGroup: "Pre stálych klientov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk", isPopular: true },
          { id: "laser-akcia-studentka", name: "STUDENT DEAL – študentská zľava", description: "Pre študentky do 26 rokov platí trvalá 15% zľava na všetky laserové služby.", duration: "individuálna", price: "15% študentská zľava", benefits: ["15% trvalá zľava", "S platným ISIC", "Na všetky laserové služby"], targetGroup: "Pre študentky do 26 rokov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-akcia-pary", name: "COUPLES DEAL – párová akcia", description: "Pre páry: obaja získajú 20% zľavu pri spoločnej rezervácii.", duration: "individuálna", price: "20% zľava pre oboch", benefits: ["20% zľava", "Pre páry", "Spoločná rezervácia"], targetGroup: "Pre páry", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" },
          { id: "laser-akcia-narodeniny", name: "BIRTHDAY SPECIAL – narodeninová akcia", description: "V mesiaci vašich narodenín získate 30% zľavu na ľubovoľnú laserovú službu.", duration: "individuálna", price: "30% narodeninová zľava", benefits: ["30% zľava", "Celý mesiac narodenín", "Na jednu službu"], targetGroup: "Pre oslávencov", bookioUrl: "https://services.bookio.com/n1-pro-aesthetic/widget?lang=sk" }
        ]
      }
    ]
  },
